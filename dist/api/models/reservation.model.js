...
let ReservationSchema = class ReservationSchema extends sequelize_typescript_1.Model {
};
__decorate([
    (0, sequelize_typescript_1.Column)({ type: INTEGER, primaryKey: true, autoIncrement: true }),
    __metadata("design:type", Number)
], ReservationSchema.prototype, "reservationID", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], ReservationSchema.prototype, "inventoryID", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, { foreignKey: 'userID' }),
    (0, sequelize_typescript_1.Column)({ type: INTEGER }),
    __metadata("design:type", Number)
], ReservationSchema.prototype, "userID", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: INTEGER }),
    __metadata("design:type", Number)
], ReservationSchema.prototype, "quantity", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: INTEGER }),
    __metadata("design:type", Number)
], ReservationSchema.prototype, "orderNumber", void 0);
ReservationSchema = __decorate([
